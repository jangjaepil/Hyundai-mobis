...
#ifndef SERIAL__SERIAL_PORT_HPP_
#define SERIAL__SERIAL_PORT_HPP_

#include <array>
#include <string>
#include <vector>

#include "serial_comm/io_context/io_context.hpp"
...
namespace drivers
{
  namespace serial_driver
  {
    ...
    private:
      ...
      Functor m_func;
      static constexpr size_t m_recv_buffer_size{1000};
