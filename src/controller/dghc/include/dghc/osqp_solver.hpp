...
public:
    ...
    void qp_setConstraintVectors(unsigned int& Nt, unsigned int& Dof,Eigen::VectorXd& Ts,std::vector<Eigen::VectorXd>& allx_dot_d,Eigen::VectorXd& current_q,Eigen::VectorXd& lbq,Eigen::VectorXd& ubq,Eigen::VectorXd& q_lower_limit,Eigen::VectorXd& q_upper_limit,Eigen::VectorXd& lowerBound, Eigen::VectorXd& upperBound);
