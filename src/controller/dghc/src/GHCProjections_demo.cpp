...
unsigned int GHCProjections::getGeneralizedProjector(unsigned int i, Eigen::MatrixXd & proj){
    ...
    //  std::cout<<"getAiVec done"<<std::endl;
    ...
    //   std::cout<<"getJaugmented done"<<std::endl;
    ...
    //   std::cout<<"getTaskIDXaugmented done"<<std::endl;
    ...
    //  std::cout<<"Aisorted done"<<std::endl;
...
unsigned int GHCProjections::getNumTasks(){
    return numTasks;
}
