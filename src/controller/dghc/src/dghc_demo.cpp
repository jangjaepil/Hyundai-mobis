...
int main(int argc, char * argv[])
{
    ...
    Qr.diagonal() << 0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001, //task 1 : wheel vel
                     0.001,0.001,0.001,0.001,                     //task 1 : lift vel
                     0.001,0.001,0.001,0.001,0.001,0.001,                 //task 1 : mani vel
